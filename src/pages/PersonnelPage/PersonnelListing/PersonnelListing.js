...
const PersonnelListing = (props) => {
  ...
  const refreshHandler = () => {
    ...
    setTimeout(() => {
      setRefresh(false);
      dispatch({ type: GET_ALL_PERSONNEL, payload: {...refreshBody, pageIndex: 1} });
    }, 300);
  };
            ...
            <div className="client-listing-toolbar-right">
              ...
              <div className="client-listing-toolbar-right-csv-download mrg">
                <a
                  ...
                  href={`${SCAI_API_PERSONNEL}/csv?tenant_id=${tenantId}&bu_id=${buId}`}
                >
                  {" "}
                  {t("CSV Download")}{" "}
        ...
        <Dialog id="window">
          ...
          <DialogActionsBar>
            <a
              ...
              href={`${SCAI_API_PERSONNEL}/template?tenant_id=${tenantId}&bu_id=${buId}`}
            >
              {t("Download Template")}
