...
const EditTeam = () => {
  ...
  const editteamBU = useSelector((state) => state.TeamUnitReducer.selectedTeam);
  ...
  const onSubmit = () => {
    if (validator.allValid()) {
      let localNumber = formatPhoneNumber(formData.contact_person_number);
      ...
      formData.contact_person_country_code = localNumberArray[0];
